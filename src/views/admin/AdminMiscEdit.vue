      ...
      <div class="space-y-6">
        ...
        <div class="bg-[rgb(60,0,0)] border border-[#c9c9c9]/20 rounded-xl p-6 space-y-5">
          ...
          <div class="flex gap-6">
            <AdminInput v-model="misc.description" label="描述" placeholder="杂记描述" class="flex-1" />
            <div class="space-y-2 min-w-27.5">
              ...
              <div class="flex items-center h-11.5">
                <label class="flex items-center gap-3 cursor-pointer group">
                  ...
                  <span class="text-[#c9c9c9] text-sm transition-colors group-hover:text-red-300 w-12">{{
                    misc.published ? '已发布' : '草稿'
                  }}</span>
                </label>
              </div>
            </div>
