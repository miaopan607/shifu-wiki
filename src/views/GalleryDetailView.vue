        ...
        <div class="max-w-4xl mx-auto">
            <header class="mb-12">
                ...
                <div v-if="gallery">
                    ...
                    <div v-if="gallery.description" class="text-[#c9c9c9]/80 text-lg leading-relaxed tracking-wider prose prose-invert" v-html="renderMarkdown(gallery.description)"></div>
                </div>
            </header>
