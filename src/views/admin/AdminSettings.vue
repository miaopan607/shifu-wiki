  ...
  <div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="bg-[rgb(60,0,0)] border border-[#c9c9c9]/20 rounded-xl p-6 space-y-5">
      <div>
        ...
        <p class="mt-2 text-sm text-[#888]"
          >控制后台上传时允许同时进行的上传数量。数值越大，速度可能更快，但也更容易占满带宽。</p
        >
      </div>
    ...
    <div class="bg-[rgb(60,0,0)] border border-[#c9c9c9]/20 rounded-xl p-6 space-y-5">
        ...
        <label class="flex items-center gap-3 cursor-pointer select-none">
          <button
            ...
            :class="[
              ...
              draftSkipSingleLockDeleteConfirm ? 'bg-red-700' : 'bg-[#888]/30',
            ]"
          ...
          >
            <span
              :class="[
                ...
                draftSkipSingleLockDeleteConfirm ? 'translate-x-6' : 'translate-x-1',
              ]"
            />
          </button>
      ...
      <p class="text-sm text-[#888]"
        >当前状态：{{
          draftSkipSingleLockDeleteConfirm ? '已开启，单个移除将不再提示' : '已关闭，单个移除仍会先确认'
        }}。</p
      >
