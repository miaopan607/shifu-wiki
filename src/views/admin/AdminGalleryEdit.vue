            ...
            <div class="lg:col-span-4 lg:order-2 space-y-6">
                ...
                <div class="bg-[rgb(60,0,0)] border border-[#c9c9c9]/20 rounded-xl p-6 space-y-5">
                    ...
                    <div class="space-y-2">
                        ...
                        <div v-if="showPreview" class="w-full px-4 py-3 bg-black/10 border border-[#c9c9c9]/10 rounded-lg text-[#e0e0e0] min-h-25 prose prose-invert prose-sm max-w-none" v-html="renderMarkdown(form.description)"></div>
                        <textarea
                            v-else
