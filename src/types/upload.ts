...
// 批量任务类型
export type BatchTaskType = 'gallery_images' | 'album_cover';

// 批量上传任务状态
export type BatchTaskStatus = 'pending' | 'uploading' | 'success' | 'error' | 'paused' | 'partial_success' | 'cancelled';
...
export interface BatchUploadTask {
	...
	targetName: string; // 图集/专辑名称，用于显示
	serverBatchId?: string;
	lockId?: string;
	lockCollection?: 'galleries' | 'albums';
